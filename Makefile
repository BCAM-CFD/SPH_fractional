...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(srcdir)/config.h.in README compile install-sh missing
...
STRIP = 
VERSION = 1.0
abs_builddir = /dipc/lsantelli/MCF-intel-2/MCF-run-3d/mcf
abs_srcdir = /dipc/lsantelli/MCF-intel-2/MCF-run-3d/mcf
