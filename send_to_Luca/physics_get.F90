...
!--------------------------------------------------
      ...
      REAL(MK) FUNCTION physics_get_time_saved(this,stat_info)
        ...
        physics_get_time_saved = this%time_saved
        
        RETURN
        
      END FUNCTION physics_get_time_saved
      !***********************************************************

      !**** Added by Adolfo for the integral fractional model ****
      SUBROUTINE physics_get_mem_function(this,d_mem_function,stat_info)
       
        TYPE(Physics), INTENT(IN)           :: this
        REAL(MK), DIMENSION(:), ALLOCATABLE :: d_mem_function
        INTEGER, INTENT(OUT)                :: stat_info
        
        stat_info = 0
        
        IF(ALLOCATED(d_mem_function))THEN
           DEALLOCATE(d_mem_function)
        END IF
        
        ALLOCATE(d_mem_function(this%Nsteps_memory))
        d_mem_function(1:this%Nsteps_memory) = this%mem_function(1:this%Nsteps_memory)
        
        RETURN
        
      END SUBROUTINE physics_get_mem_function
      !***********************************************************      
      
      !*********** Added by Adolfo for the fractional model *************
      INTEGER FUNCTION physics_get_steps_since_last_saved_pos(this,stat_info)
        ...
        physics_get_steps_since_last_saved_pos = this%steps_since_last_saved_pos
        
        RETURN
        
      END FUNCTION physics_get_steps_since_last_saved_pos
      !******************************************************************


      !*********** Added by Adolfo for the fractional model *************
      INTEGER FUNCTION physics_get_freq_integration(this,stat_info)
        ...
        physics_get_freq_integration = this%freq_integration
        
        RETURN
        
      END FUNCTION physics_get_freq_integration
      !******************************************************************

      !*********** Added by Adolfo for the fractional model *************
      INTEGER FUNCTION physics_get_Npoints_integration(this,stat_info)
        ...
        physics_get_Npoints_integration = this%Npoints_integration
...
!************** Added by Adolfo **********
      REAL(MK) FUNCTION physics_get_a(this,stat_info)
        ...
        physics_get_a = this%a
        
        RETURN
        
      END FUNCTION physics_get_a

      REAL(MK) FUNCTION physics_get_b(this,stat_info)
