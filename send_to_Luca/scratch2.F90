!****************** SUBROUTINE modified by Adolfo_neighbours **************
SUBROUTINE particles_compute_density(this,stat_info)
	...
	!----------------------------------------------------
        ...
        !******* Adolfo_neighbours *********
        !******** Densities are calculated here *******
        DO ip = 1, this%num_part_all
           DO k_neigh = 1, this%Nneigh(ip)
              jp = this%neigh(k_neigh, ip)
              ...
              !-------------------------------
              ! Density calculated for fluid particles, or
              ! boundary particle without constant density type.
              !-------------------------------
