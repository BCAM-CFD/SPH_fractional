...
!***************** Added by Adolfo **************
      INTEGER FUNCTION colloid_get_implicit_pair_num_sweep_tang(this, stat_info)
        !----------------------------------------------------
        ! Return the number of implicit pair sweeps
        !----------------------------------------------------
        ...
        stat_info = 0
        colloid_get_implicit_pair_num_sweep_tang = this%implicit_pair_num_sweep_tang
        
        RETURN
        
      END FUNCTION colloid_get_implicit_pair_num_sweep_tang
...
!************ Added by Adolfo *************
      REAL(MK) FUNCTION colloid_get_implicit_pair_sweep_error_tang(this,&
           stat_info)
        !----------------------------------------------------
        ! Return the error of implicit pair sweeps
        !----------------------------------------------------
        ...
        stat_info = 0
        colloid_get_implicit_pair_sweep_error_tang = &
             this%implicit_pair_sweep_error_tang
        
        RETURN
        
      END FUNCTION colloid_get_implicit_pair_sweep_error_tang
!****** END OF Added by Adolfo *************     
...
9999    CONTINUE
	 ...
	 !** Adolfo comment **
	 ! There is a problem in here, d_vector in 3D should have 9 numbers,
	 ! and here there are only 4. **
	 !--- Modified by Adolfo ---
         ALLOCATE(d_vector(4,this%num_colloid))
