...
9999    CONTINUE
      ...
      !************** Added by Adolfo **********
      SUBROUTINE particles_get_x_adolfo(this,x,num,stat_info)
...
9999    CONTINUE
      ...
      END SUBROUTINE particles_get_x_adolfo
!****************************************
      ...
      SUBROUTINE particles_get_v(this,v,num,stat_info)
        ...
        IF ( num > 0 ) THEN
           ...
           !********** Changed by Adolfo ***********
           !*** To avoid a run-time error at hpcwales ***
!           v(1:dim,1:num) = this%v(1:dim,1:num)           
           DO I = 1, dim
              v(I,1:num) = this%v(I,1:num)
           ENDDO
           !****************************************
