      SUBROUTINE  particles_init_global_inter_cubic(this,stat_info)
        !----------------------------------------------------
        ! Subroutine  : particles_init_global_inter_cubic
        !----------------------------------------------------
        !
        ! Purpose     : Create positions for particles in 
        !               total physical domain on simple 
        !               cubic lattice.
        !
        ! Routines    :
        !
	...
	! v   : velocity
        ...
        sx(3) = min_phys_t(3) + 0.5_MK * dx(3)

        DO WHILE( sx(3) < max_phys_t(3) )                 
...
9999	CONTINUE	
      ...
      END SUBROUTINE particles_init_global_inter_cubic
