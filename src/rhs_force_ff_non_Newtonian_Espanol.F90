!************ Subroutine modified by Adolfo for the integral fractional model *************
! This subroutine does not compute the Español and Revenga modelo from 2003,
! but a version similar to the model of Hu and Adams, where the only
! viscous term in the momentum equation is
...
!        f_d =  a * gradw / numi / numj /  dij
        f_d =  2.0_MK * eta * gradw / numi / numj /  dij
...
!!$        
!!$        fi(1:num_dim) = fi(1:num_dim) + f_d * eij(1:num_dim) / mi 
