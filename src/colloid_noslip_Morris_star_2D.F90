      SUBROUTINE colloid_noslip_Morris_star_2D(this, &
...
#if 0
        CALL colloid_polar_star_intersectP(this%radius(1,sid_c),&
        ...
        convex = colloid_polar_star_convex(REAL(this%freq(sid_c),MK),&
        ...
        IF ( convex ) THEN
           ...
           CALL colloid_polar_star_shortestD(this%radius(1,sid_c),&
                this%radius(2,sid_c),REAL(this%freq(sid_c),MK), &
