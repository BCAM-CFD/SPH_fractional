      SUBROUTINE colloid_noslip_Morris_disk(this, &
           xf,xc,vf,vc,sid_c,stat_info)
        !----------------------------------------------------
        ! Subroutine  : colloid_noslip_Morris_disk
        !----------------------------------------------------
        ! Purpose     : For 2D disk velocity
        !               no-slip boundary condition.
        !
        ! Remark      : it is identical to 2D cylinder.
        !
...
9999    CONTINUE
      ...
      END SUBROUTINE colloid_noslip_Morris_disk
