...
9999    CONTINUE
      ...
      !******** Added by Adolfo *************
      SUBROUTINE colloid_set_implicit_pair_num_sweep_tang(this,d_num,stat_info)
        !----------------------------------------------------
        ! Set the number of sweep for pairwise implicit
        ! splitting scheme.
        !---------------------------------------------------
        ...
        this%implicit_pair_num_sweep_tang = d_num
        
        RETURN
        
      END SUBROUTINE colloid_set_implicit_pair_num_sweep_tang
...
!*************** Added by Adolfo **********
      SUBROUTINE colloid_set_implicit_pair_sweep_error_tang(this,d_error,stat_info)
        !----------------------------------------------------
        ! Set the error of sweep for pairwise implicit
        ! splitting scheme.
        !---------------------------------------------------
        ...
        this%implicit_pair_sweep_error_tang = d_error
        
        RETURN
        
      END SUBROUTINE colloid_set_implicit_pair_sweep_error_tang
!**************************************    
