!************* Modified by Adolfo for the fractional model ***************
...
!**************************************************************************
	...
	!----------------------------------------------------
        ...
        IF ( map_x_old ) THEN
           ...
           CALL  ppm_map_part_ghost(this%x_old,num_dim,&
                this%num_part_real,this%num_part_all,&
                isymm,ghost_size,map_type,stat_info_sub)
        ...
        IF ( map_dx_prev ) THEN
           ...
           CALL  ppm_map_part_ghost(this%dx_prev,num_dim*Npoints_integration,&
                this%num_part_real,this%num_part_all,&
                isymm,ghost_size,map_type,stat_info_sub)
        ...
        IF ( map_gradx_prev ) THEN
           ...
           CALL  ppm_map_part_ghost(this%gradx_prev,num_dim*num_dim*Npoints_integration,&
                this%num_part_real,this%num_part_all,&
                isymm,ghost_size,map_type,stat_info_sub)
