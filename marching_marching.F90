...
!****** Added by Adolfo *******
        ...
        REAL(MK)                        :: coll_implicit_pair_sweep_error_tang
!******************************
...
!********** Added by Adolfo ****************
!              coll_implicit_pair_num_sweep_tang = &
!                   colloid_get_implicit_pair_num_sweep_tang(colloids,stat_info_sub)
!              coll_implicit_pair_sweep_error_tang = &
!                   colloid_get_implicit_pair_sweep_error_tang(colloids,stat_info_sub)
!*******************************************
...
!             num_part_all,stat_info_sub)        
        ALLOCATE(t_x(SIZE(this%particles%x,1), SIZE(this%particles%x,2)))
        CALL particles_get_x_adolfo(this%particles,t_x, &
             num_part_all,stat_info_sub)        
        !****************************************
...
!!$                stat_info = stat_info_sub)
        ...
        IF( .NOT. Newtonian ) THEN
           CALL particles_update_previous_x(this%particles,&
                num_part_all,stat_info_sub)
        ENDIF
        !*******************************************************
